...
<footer className="bg-aftb_orange ">
  <div className="max-w-screen-xl px-4 py-16 mx-auto sm:px-6 lg:px-8">
    <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
      <div>
      <img src="#" className="mr-5 h-6 sm:h-9" alt="logo" />
        <p className="max-w-xs mt-4 text-sm text-white">
            Desenvolvido e gerenciado por: <br/> <span className="text-xl">After The Box Company</span> 
        </p>
  ...
  <footer className="footer footer-center  w-full p-4 bg-aftb_orange text-gray-800">
