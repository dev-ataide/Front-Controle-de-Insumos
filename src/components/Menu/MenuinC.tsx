  ...
  return (
    ...
    {menu ?(
      <div className="font-poppins antialiased bg-white bg-gradient-to-bl h-screen border-r-4 hidden sm:block relative">
        ...
        <nav className="mt-0">
          <div>
            <a className="w-full font-thin uppercase text-gray-500 dark:text-aftb_blue_active flex items-center px-4 pb-4 mb-2 transition-colors duration-200 justify-start hover:text-aftb_orange border-r-4 dark:border-transparent dark:from-gray-700 dark:to-gray-800 hover:border-aftb_orange" href="/home">
