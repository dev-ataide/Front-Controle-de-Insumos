                ...
                <div className="mx-8 px-4 py-4 overflow-x-hidden">
                  <div className="inline-block min-w-full shadow rounded-lg overflow-hidden">
                    <table className="min-w-full leading-normal">
                      ...
                      <tbody>
                        {currentItens.map((clientes) => (
                          <tr key={clientes.id}>
                            <td className="pl-5 py-5 border-b border-gray-200 bg-white text-sm ">
                              {clientes.photo ? (
                                <img src={`http://localhost:3333/files/${clientes.photo}`} alt="Imagem do Cliente" width="60" height="" />
                              ) : (
                            ...
                            <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                              <p className="text-gray-900 whitespace-no-wrap">{clientes.name}</p>
                            </td>
                            <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                              <p className="text-gray-900 whitespace-no-wrap">{clientes.cpf}</p>
                            </td>
                            <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm ">
                              <a href={`https://api.whatsapp.com/send?1=pt_BR&phone=${encodeURIComponent(clientes.contact)}`} target="_blank" className="flex items-center">
                                <p className="text-gray-900 whitespace-no-wrap mr-8">{clientes.contact}
                                </p>
                            ...
                            <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                              <p className="text-gray-900 whitespace-no-wrap">{clientes.email}</p>
                            </td>
                            <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                              <p className="text-gray-900 whitespace-no-wrap">{clientes.observer}</p>
                            </td>
                          </tr>
                        ))}
                      </tbody>
