                  ...
                  <tr key={client.id}>
                    ...
                    <td className="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap">
                      <div className="flex items-center gap-x-2">
                        ...
                        <div>
                          <h2 className="text-sm font-medium text-gray-800 ">{client.email}</h2>
                          <div className='flex'>
                            <a href={`https://api.whatsapp.com/send?1=pt_BR&phone=${encodeURIComponent(client.contact)}`} target="_blank" className="text-xs font-normal text-aftb_greenbuton ">{client.clientContact}</a>
